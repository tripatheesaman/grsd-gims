...
router.get('/assets', verifyJWT, getAssetsReport);
router.post('/assets/export', verifyJWT, exportAssetsReport);
router.get('/insurance', verifyJWT, getInsuranceReport);
router.post('/insurance/export', verifyJWT, exportInsuranceReport);
